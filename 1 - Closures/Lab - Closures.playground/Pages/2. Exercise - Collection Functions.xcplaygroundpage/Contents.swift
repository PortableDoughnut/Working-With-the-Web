 ...
 */
func forwards(_ nameOne: String, _ nameTwo: String) -> Bool {
//	print("\(nameOne)")
//	print("\(nameTwo)")
...
let friendsAndFamily: [String] = ["Brett",
								  "Alicia",
								  "Meagan",
								  "Mads",
								  "Cheyenne",
...
let sortedCollection2: [String] = friendsAndFamily.sorted {
...
let sortedCollection3: [String] = friendsAndFamily.sorted {	$0 < $1	}

for person in sortedCollection3 {
	print(person)
}
/*:
